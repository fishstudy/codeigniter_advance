...
<!-- 主体部分 start -->
<div class="ic_content ms-controller" id="container" ms-controller="wz-hotevent-popular">
						...
						<div class="crc_list" ms-repeat-item="products" ms-visible="products.length">
							...
							<h3>商品</h3>
							 ...
							 <p>
							  ...
							  <input type="text" ms-attr-id="buy_title_{{$index}}" placeholder="最多30个字" name="c[shopproduct][title]" ms-attr-value="item.title" size="50" />
							  </p>
							  <!--<p>
...
<script type="text/javascript">
    ...
    require(["wz/popularDetailPage","wz/navBar","utils/utils"], function(vm,navBar,utils) {
        VM = vm;
		//wzVM = vm.VM;
        vm.init();
		...
		//navBar
		var catalogId = utils.getQueryString("catalogId");	
		navBar.showChildren("search");
		navBar.setCurrent("wz-nav-popular-" + catalogId);
    });
</script>
