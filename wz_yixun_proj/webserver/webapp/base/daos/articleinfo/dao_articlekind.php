 ...
 * @license 
 */
class Dao_articlekind extends Bs_dao {
    /**
     * _table 
     * 
     * @var mixed
     ...
     * @access protected
     */
    protected $_insert_fields = array('id', 'wzId', 'kindName', 'updateTime');
    protected $_update_fields = array('id', 'wzId', 'kindName', 'updateTime');
    protected $_select_fields = array('id', 'wzId', 'kindName', 'createTime', 'updateTime');
    protected $_primary_key = 'id';
    protected $_unique_fields = array('id');
    protected $_index_fields = array('wzId' => array(1 => 'wzId', ),);
    protected $_dao = '';
    ...
    function search($param = array()) {
        ...
        $equal_search_items = array('id'=>'t','wzId'=>'t');
