 ...
 * @license 
 */
class Dao_articleinfo extends Bs_dao {
    /**
     * _table 
     * 
     * @var mixed
     ...
     * @access protected
     */
    protected $_insert_fields = array('articleId', 'authorid', 'secretid', 'wzId', 'title', 'zdmTitle', 'brief', 'microUrl', 'readNum', 'praiseNum', 'conditions', 'hitShelveTime', 'createTime', 'updateTime', 'updateUser', 'categories','kindId');
    protected $_update_fields = array('id', 'articleId', 'authorid', 'secretid', 'wzId', 'title', 'zdmTitle', 'brief', 'microUrl', 'readNum', 'praiseNum', 'conditions', 'hitShelveTime', 'updateTime', 'updateUser', 'categories', 'orderNum','kindId');
    protected $_select_fields = array('id', 'articleId', 'authorid', 'secretid', 'wzId', 'title', 'zdmTitle', 'brief', 'microUrl', 'readNum', 'praiseNum', 'conditions', 'hitShelveTime', 'createTime', 'updateTime', 'updateUser', 'categories','kindId', 'orderNum');
    ...
    function search($param = array()) {
        ...
        $equal_search_items = array('id'=>'t','orderNum'=>'t','wzId'=>'t','conditions'=>'t','categories'=>'t','kindId'=>'t');
        $like_search_items  = array('title'=>'t');
