 ...
 * @license 
 */
class Dao_webmaster extends Bs_dao {
    /**
     * _table 
     * 
     * @var mixed
     ...
     * @access protected
     */
    protected $_insert_fields = array('name', 'username', 'mobile', 'iccard','authentication','createTime', 'createUser', 'conditions', 'logo','updateTime', 'updateUser', 'rejection', 'closereason');
    protected $_update_fields = array('name', 'username', 'mobile', 'iccard', 'level', 'authentication', 'qq', 'weChat', 'wzUrl', 'weibo', 'createUser', 'updateTime', 'updateUser', 'conditions', 'logo', 'introduction', 'confirmTime', 'confirmUser','rejection','closereason');
    protected $_select_fields = array('id', 'name', 'username', 'mobile', 'iccard', 'level', 'authentication', 'qq', 'weChat', 'wzUrl', 'weibo', 'createTime', 'createUser', 'updateTime', 'updateUser', 'conditions', 'logo', 'introduction', 'confirmTime', 'confirmUser','rejection','closereason');
    ...
    function search($param = array()) {
        ...
        $equal_search_items = array('id'=>'t','conditions'=>'','username'=>'','authentication'=>'','mobile'=>'','iccard'=>'');
