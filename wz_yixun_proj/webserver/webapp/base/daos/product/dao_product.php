 ...
 * @license 
 */
class Dao_product extends Bs_dao {
    /**
     * _table 
     * 
     * @var mixed
     ...
     * @access protected
     */
    protected $_insert_fields = array('wzId', 'tfId', 'status', 'createTime', 'createUser', 'updateTime', 'updateUser');
    protected $_update_fields = array('id', 'wzId', 'tfId', 'status', 'updateTime', 'updateUser');
    protected $_select_fields = array('id', 'wzId', 'tfId', 'status', 'createTime', 'createUser', 'updateTime', 'updateUser');
    ...
    function search($param = array()) {
        ...
        $equal_search_items = array('id'=>'t','wzId'=>'','tfId'=>'','status'=>'');
