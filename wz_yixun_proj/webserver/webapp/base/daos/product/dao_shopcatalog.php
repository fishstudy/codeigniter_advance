 ...
 * @license 
 */
class Dao_shopcatalog extends Bs_dao {
    /**
     * _table 
     * 
     * @var mixed
     ...
     * @access protected
     */
    protected $_insert_fields = array('id', 'wzId', 'tfId', 'catalogName', 'createTime', 'updateTime');
    protected $_update_fields = array( 'wzId', 'tfId', 'catalogName','createTime','updateTime');
    protected $_select_fields = array('id', 'wzId', 'tfId', 'catalogName', 'createTime', 'updateTime');
    protected $_primary_key = 'id';
    protected $_unique_fields = array('id');
    protected $_index_fields = array('wzId' => array(1 => 'wzId', ),'tfId' => array(1 => 'tfId', ),);
    protected $_dao = '';
    ...
    function search($param = array()) {
        ...
        $equal_search_items = array('id'=>'t','wzId'=>'t','tfId'=>'t');
