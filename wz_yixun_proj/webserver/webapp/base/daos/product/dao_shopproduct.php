 ...
 * @license 
 */
class Dao_shopproduct extends Bs_dao {
    /**
     * _table 
     * 
     * @var mixed
     ...
     * @access protected
     */
    protected $_insert_fields = array('id', 'wzId', 'scId', 'pId', 'info', 'pic', 'type', 'title', 'updateTime');
    protected $_update_fields = array('id', 'wzId', 'scId', 'pId', 'info', 'pic', 'type', 'title', 'updateTime');
    protected $_select_fields = array('id', 'wzId', 'scId', 'pId', 'info', 'pic', 'type', 'title', 'createTime', 'updateTime');
    protected $_primary_key = 'id';
    protected $_unique_fields = array('id');
    protected $_index_fields = array('wzId' => array(1 => 'wzId', ),'type' => array(1 => 'type', ),);
    protected $_dao = '';
    ...
    function search($param = array()) {
        ...
        $equal_search_items = array('id'=>'t','wzId'=>'t','scId'=>'t','pId'=>'t','type'=>'t');
