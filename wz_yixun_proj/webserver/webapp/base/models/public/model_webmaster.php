 ...
 * @license 
 */
class Model_webmaster extends Bs_model {
    protected $_has_one  = array();
    protected $_has_many = array();
    protected $_model    = '';
    protected $_cache_keys = array(
             'Bs_Model_webmaster_conditions:%d' => array('conditions'),
             'Bs_Model_webmaster_mobile:%d' => array('mobile'),
             'Bs_Model_webmaster_username:%s' => array('username'),
             'Bs_Model_webmaster' => array(),            
    );
    protected $_equal_search_items = array('username','mobile','iccard');
