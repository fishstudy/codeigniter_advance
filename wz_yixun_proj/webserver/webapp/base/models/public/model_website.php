 ...
 * @license 
 */
class Model_website extends Bs_model {
    protected $_has_one  = array();
    protected $_has_many = array();
    protected $_model    = '';
    protected $_cache_keys = array(
             'Bs_Model_website_webMasterId:%d:conditions:%d' => array('webMasterId', 'conditions'),
             'Bs_Model_website_webMasterId:%d' => array('webMasterId'),
             'Bs_Model_website_conditions:%d' => array('conditions'),
             'Bs_Model_website' => array(),            );
    protected $_equal_search_items = array('webMasterId'=>'t', 'conditions'=>'t');
