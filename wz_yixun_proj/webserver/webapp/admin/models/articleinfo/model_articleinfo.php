 ...
 * @license 
 */
class Model_articleinfo extends Adm_model {
    const ID_CACHE_NUM=10;
    protected $_has_one  = array();
    protected $_has_many = array();
    protected $_model    = '';
    protected $_cache_keys = array(
                 'Wd_Model_articleinfo_wzId:%d_condition:%d:_category:%d' => array('wzId','conditions','categories'),
                 'Wd_Model_articleinfo_wzId:%d_conditions:%d' => array('wzId','conditions'),
                 'Wd_Model_articleinfo_wzId:%d_category:%d' => array('wzId','categories'),
                 'Wd_Model_articleinfo_category:%d' => array('categories'),
                 'Wd_Model_articleinfo' => array(),     
              );
    protected $_equal_search_items = array('wzId'=>'t','conditions'=>'t','categories'=>'t');
     ...
     * 根据文章ID 获取文章在改微站的顺序
     */
    function get_website_article_list($websiteid=0,$articleid=0 ){
        $return = array();
        ...
        $redis_key = sprintf("Wd_Model_articleinfo_wzId:%d",$websiteid); 
...
//             die();
    ...
    function search($param = array(), $page = 0, $pagesize = 0) {
        ...
        $param['ordersort']     =  'orderNum DESC,createTime DESC';
