...
<div class="am-cf admin-main">
    ...
    <div class="am-cf am-padding">
      <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">微站站长</strong> / <small>所有<font color="green">已认证</font>站长列表</small></div>
    </div>
    ...
    <div class="am-g">
      <div class="am-u-sm-12">
            ...
            <tr>
              ...
              <td>
                <div class="am-btn-toolbar">
                  <div class="am-btn-group am-btn-group-xs">
                  <a href="<#$admindomain#>admin/master/detailmaster/<#$items.id#>" class="am-btn am-btn-default am-btn-xs am-text-secondary" >
                  	<span class="am-icon-pencil-square-o"></span> 设置投放</a>
                  <!--
		...
		-->	
          <hr />
          <p>注：管理员一期点击详情页面去设置投放ID和商品池ID。</p>
        </form>
      </div>
...
<script type="text/javascript">
	...
	function checksearch(){
		...
		var url = '<#$admindomain#>admin/master/searchmaster';
		form.action = url;
		form.submit();
	}
</script>
