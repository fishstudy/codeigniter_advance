 ...
 * @license 
 */
class Dao_articleinfo extends Adm_dao {
    /**
     * _table 
     * 
     * @var mixed
     ...
     * @access protected
     */
    protected $_insert_fields = array('id', 'articleId', 'wzId', 'title', 'readNum', 'praiseNum', 'conditions', 'hitShelveTime', 'updateTime', 'updateUser', 'categories', 'sources', 'orderNum');
    protected $_update_fields = array('id', 'articleId', 'wzId', 'title', 'readNum', 'praiseNum', 'conditions', 'hitShelveTime', 'updateTime', 'updateUser', 'categories', 'sources', 'orderNum');
    protected $_select_fields = array('id', 'articleId', 'wzId', 'title', 'readNum', 'praiseNum', 'conditions', 'hitShelveTime', 'createTime', 'updateTime', 'updateUser', 'categories', 'sources', 'orderNum');
    ...
    function search($param = array()) {
        ...
        $equal_search_items = array('id'=>'t','orderNum'=>'t');
