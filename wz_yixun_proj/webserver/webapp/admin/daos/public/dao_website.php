 ...
 * @license 
 */
class Dao_website extends Wd_dao {
    /**
     * _table 
     * 
     * @var mixed
     ...
     * @access protected
     */
    protected $_insert_fields = array('id', 'webMasterId', 'bgPicture', 'articleList', 'productList', 'actList', 'createUser', 'updateTime', 'updateUser', 'conditions', 'articleModel', 'productModel', 'actModel', 'advModel');
    protected $_update_fields = array('id', 'webMasterId', 'bgPicture', 'articleList', 'productList', 'actList', 'createUser', 'updateTime', 'updateUser', 'conditions', 'articleModel', 'productModel', 'actModel', 'advModel');
    protected $_select_fields = array('id', 'webMasterId', 'bgPicture', 'articleList', 'productList', 'actList', 'createTime', 'createUser', 'updateTime', 'updateUser', 'conditions', 'articleModel', 'productModel', 'actModel', 'advModel');
