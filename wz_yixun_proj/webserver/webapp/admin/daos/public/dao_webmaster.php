 ...
 * @license 
 */
class Dao_webmaster extends Adm_dao {
    /**
     * _table 
     * 
     * @var mixed
     ...
     * @access protected
     */
    protected $_insert_fields = array('id', 'name', 'level',  'authentication', 'QQ', 'weChat', 'wzUrl', 'microblog', 'createUser', 'updateTime', 'updateUser', 'conditions', 'logo', 'introduction', 'confirmTime', 'confirmUser');
    protected $_update_fields = array('id', 'name', 'level',  'authentication', 'QQ', 'weChat', 'wzUrl', 'microblog', 'createUser', 'updateTime', 'updateUser', 'conditions', 'logo', 'introduction', 'confirmTime', 'confirmUser');
    protected $_select_fields = array('id', 'name', 'level',  'authentication', 'QQ', 'weChat', 'wzUrl', 'microblog', 'createTime', 'createUser', 'updateTime', 'updateUser', 'conditions', 'logo', 'introduction', 'confirmTime', 'confirmUser');
    ...
    function search($param = array()) {
        ...
        $equal_search_items = array('id'=>'t','author'=>'conditions');
